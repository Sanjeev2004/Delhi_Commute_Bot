...
Uses asyncpg driver with SQLAlchemy 2.0 async engine for running migrations.
Imports the project's Base metadata and settings for database URL resolution.
"""
